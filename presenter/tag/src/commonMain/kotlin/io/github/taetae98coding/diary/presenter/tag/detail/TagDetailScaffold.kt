...
public fun TagDetailScaffold(
    ...
    val effect by detailStateHolder.effect.collectAsStateWithLifecycle()
    ...
    TagFetchEffect(detailStateHolder = detailStateHolder)

    TagDetailScaffoldEffect(
        state = state,
        effectProvider = { effect },
        navigateUp = onNavigateUp,
        onEffect = detailStateHolder::clearEffect,
    )
}
...
private fun TagDetailScaffoldEffect(
    state: TagDetailScaffoldState,
    effectProvider: () -> TagDetailEffect,
    navigateUp: () -> Unit,
    onEffect: () -> Unit,
) {
