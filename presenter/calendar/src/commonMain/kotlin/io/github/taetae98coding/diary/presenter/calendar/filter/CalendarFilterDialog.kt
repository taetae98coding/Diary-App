...
private enum class CalendarFilterUiState {
    Loading,
    Empty,
    Content,
}
...
@Composable
public fun CalendarFilterDialog(
    stateHolder: CalendarFilterStateHolder,
...
private fun CalendarFilterDialog(
    ...
    val uiState = when {
        pagingItems.isLoadingVisible() -> CalendarFilterUiState.Loading
        pagingItems.isEmptyVisible() -> CalendarFilterUiState.Empty
        else -> CalendarFilterUiState.Content
    }
    ...
    ModalBottomSheet(
        ...
        AnimatedContent(
            ...
            when (value) {
                CalendarFilterUiState.Loading -> {
                    LoadingBox()
                }

                CalendarFilterUiState.Empty -> {
                    Column(
