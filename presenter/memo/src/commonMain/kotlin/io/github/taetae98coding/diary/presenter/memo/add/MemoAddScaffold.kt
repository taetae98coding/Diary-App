...
internal fun MemoAddScaffold(
    ...
    val primaryMemoTagUiStatePagingItems = addStateHolder.primaryMemoTagPagingData.collectAsLazyPagingItems()
    val floatingUiState by addStateHolder.floatingUiState.collectAsStateWithLifecycle()
    val effect by addStateHolder.memoAddEffect.collectAsStateWithLifecycle()
    ...
    MemoAddScaffoldEffect(
        ...
        onEffect = addStateHolder::clearMemoAddEffect,
    )
}
