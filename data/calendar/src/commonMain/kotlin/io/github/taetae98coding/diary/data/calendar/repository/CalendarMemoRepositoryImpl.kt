...
import io.github.taetae98coding.diary.core.database.datasource.CalendarMemoLocalDataSource
...
internal class CalendarMemoRepositoryImpl(
    private val calendarMemoLocalDataSource: CalendarMemoLocalDataSource,
) : CalendarMemoRepository {
    override fun get(account: Account, dateRange: LocalDateRange): Flow<List<CalendarMemo>> {
        return calendarMemoLocalDataSource.get(account.id, dateRange)
