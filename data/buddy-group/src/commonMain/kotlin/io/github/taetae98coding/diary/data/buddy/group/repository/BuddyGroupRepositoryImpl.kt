...
internal class BuddyGroupRepositoryImpl(
    ...
    override suspend fun add(account: Account.User, detail: BuddyGroupDetail, buddyIds: Collection<Uuid>) {
        ...
        accountBuddyGroupTransaction.upsert(account.id, listOf(remote.toLocal()))
    }
    ...
    override fun page(account: Account.User): Flow<PagingData<BuddyGroup>> {
        val pager = Pager(
            ...
            remoteMediator = BuddyGroupRemoteMediator(
                account = account,
                transactor = transactor,
                accountBuddyGroupTransaction = accountBuddyGroupTransaction,
                accountBuddyGroupLocalDataSource = accountBuddyGroupLocalDataSource,
                buddyGroupRemoteDataSource = buddyGroupRemoteDataSource,
            ),
