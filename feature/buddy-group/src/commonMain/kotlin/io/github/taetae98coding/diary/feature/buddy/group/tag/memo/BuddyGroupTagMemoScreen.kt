...
@Composable
internal fun BuddyGroupTagMemoScreen(
    navigateUp: () -> Unit,
    navigateToBuddyGroupMemoAdd: () -> Unit,
    navigateToBuddyGroupMemoDetail: (Uuid) -> Unit,
    modifier: Modifier = Modifier,
    tagMemoViewModel: BuddyGroupTagMemoViewModel = koinViewModel(),
) {
    val lifecycleOwner = LocalLifecycleOwner.current
    val title by tagMemoViewModel.title.collectAsStateWithLifecycle()

    MemoListScaffold(
        listStateHolder = tagMemoViewModel,
