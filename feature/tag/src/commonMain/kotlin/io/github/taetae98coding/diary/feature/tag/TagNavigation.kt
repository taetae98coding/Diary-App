...
public fun EntryProviderBuilder<NavKey>.tagEntryProvider(
    ...
    entry<TagDetailNavKey> { navKey ->
        TagDetailScreen(
            ...
            detailViewModel = koinViewModel { parametersOf(navKey.tagId) },
        )
    }
    ...
    entry<TagMemoNavKey> { navKey ->
        TagMemoScreen(
            ...
            tagMemoViewModel = koinViewModel { parametersOf(navKey.tagId) },
        )
    }
}
