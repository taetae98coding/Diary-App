...
import io.github.taetae98coding.diary.core.datastore.di.MemoTagFetchDataStore
...
import io.github.taetae98coding.diary.core.datastore.di.TagFetchDataStore
...
public class DataStoreModule : KoinComponent {
    ...
    @Single
    @MemoFetchDataStore
    internal fun providesMemoFetchDataStore(): DataStore<Preferences> {
        return deviceProtectedDataStore("memo_fetch.preferences_pb")
    }

    @Single
    @TagFetchDataStore
    internal fun providesTagFetchDataStore(): DataStore<Preferences> {
        return deviceProtectedDataStore("tag_fetch.preferences_pb")
    }

    @Single
    @MemoTagFetchDataStore
    internal fun providesMemoTagFetchDataStore(): DataStore<Preferences> {
        return deviceProtectedDataStore("memo_tag_fetch.preferences_pb")
    }
