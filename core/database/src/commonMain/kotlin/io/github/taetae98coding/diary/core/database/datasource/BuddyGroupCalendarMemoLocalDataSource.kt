...
@Factory
public class BuddyGroupCalendarMemoLocalDataSource internal constructor(
    private val database: DiaryDatabase,
) {
    public fun get(buddyGroupId: Uuid, dateRange: LocalDateRange): Flow<List<CalendarMemoLocalEntity>> {
        return database.buddyGroupCalendarMemo().get(buddyGroupId, dateRange.start, dateRange.endInclusive)
    }
}
