...
@Dao
internal abstract class CalendarMemoDao {
    ...
    @Query(
        ...
        AND (
                (
                    ...
                    WHERE CalendarMemoTagFilter.isFilter = 1
                ) = 0
            OR
                (
                    Memo.id IN (
                        ...
                        FROM MemoTag
                        INNER JOIN CalendarMemoTagFilter ON CalendarMemoTagFilter.tagId = MemoTag.tagId AND CalendarMemoTagFilter.isFilter = 1
