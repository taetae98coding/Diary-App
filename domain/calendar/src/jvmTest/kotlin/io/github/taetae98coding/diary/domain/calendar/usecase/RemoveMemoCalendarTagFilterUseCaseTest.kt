        ...
        Given("태그 필터를 제거하는 경우") {
            ...
            When("UseCase를 실행하면") {
                ...
                Then("Repository 호출한다") {
                    coVerify(exactly = 1) { memoCalendarTagFilterRepository.upsert(tagId, false) }
                }
            }
        }
    }
