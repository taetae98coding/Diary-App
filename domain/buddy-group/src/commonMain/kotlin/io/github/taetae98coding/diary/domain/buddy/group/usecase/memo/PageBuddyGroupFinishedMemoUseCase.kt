...
@Factory
public class PageBuddyGroupFinishedMemoUseCase internal constructor(
    private val getAccountUseCase: GetAccountUseCase,
    private val buddyGroupFinishedMemoRepository: BuddyGroupFinishedMemoRepository,
) {
            ...
            getAccountUseCase().mapLatest { it.getOrThrow() }
                .flatMapLatest { account ->
                    when (account) {
                        ...
                        is Account.User -> buddyGroupFinishedMemoRepository.page(account, buddyGroupId)
