...
@Factory
public class PageBuddyGroupTagUseCase internal constructor(
            ...
            getAccountUseCase().mapLatest { it.getOrThrow() }
                .flatMapLatest { account ->
                    when (account) {
                        ...
                        is Account.User -> buddyGroupTagRepository.page(account, buddyGroupId).mapLatest { Result.success(it) }
                    }
                }
                .also { emitAll(it) }
        }.catch {
