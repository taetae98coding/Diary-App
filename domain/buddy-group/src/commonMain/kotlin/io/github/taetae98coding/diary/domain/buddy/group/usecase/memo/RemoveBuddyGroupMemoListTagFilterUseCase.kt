...
@Factory
public class RemoveBuddyGroupMemoListTagFilterUseCase internal constructor(
    ...
    public suspend operator fun invoke(buddyGroupId: Uuid, tagId: Uuid): Result<Unit> {
        return runCatching { buddyGroupMemoListTagFilterRepository.upsert(buddyGroupId, tagId, false) }
    }
}
