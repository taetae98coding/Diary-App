        ...
        Given("로그인 사용자로 태그를 완료 처리하는 경우") {
            ...
            When("유즈케이스를 실행하면") {
                ...
                Then("Repository와 백업 유즈케이스가 호출된다") {
                    coVerify(exactly = 1) { accountTagRepository.updateFinished(account, tagId, true) }
